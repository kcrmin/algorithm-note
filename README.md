...
## 폴더 규칙
- `_notes/Foundations`: 자료구조, 수학, 복잡도 등 기초
- `_notes/Topics`: 알고리즘 주제별 정리 (예: Graph, DP, Greedy, Tree, String)
- `_notes/Techniques`: 공통 풀이 테크닉 (예: Two Pointers, Sliding Window, Parametric Search)
- `_templates/`: 노트 작성 템플릿
- `_inbox/`: 임시 메모, TODO, 초안
- `_assets/`: 이미지/첨부 자료
